    ...
    // 2. Variants (Colors)
    const variants = {
        primary: "bg-[#135CF4] text-white hover:bg-blue-700 focus:ring-blue-500 shadow-md hover:shadow-lg",
        secondary: "bg-gray-800 text-white hover:bg-gray-900 focus:ring-gray-500",
        outline: "border-2 border-[#135CF4] text-[#135CF4] bg-transparent hover:bg-blue-50",
