            ...
            <div className="flex flex-col flex-1 h-screen">
                ...
                <main className="flex-1 overflow-y-auto p-2 pb-20 relative">
                    <div className="bg-white p-6 rounded-2xl shadow-lg shadow-black/5 mb-4">
                        ...
                        <h1 className="text-3xl font-bold mb-2 text-gray-800">Analytics</h1>
                        <p className="text-gray-400">Analyze your social media performance with in-depth insights.</p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-lg shadow-black/5 mt-2">
                        <h1 className="font-black text-xl text-gray-800">Analytics Dashboard</h1>   
                        <p className="text-gray-500 text-sm mt-1">View detailed analytics to optimize your social media strategies.</p>
